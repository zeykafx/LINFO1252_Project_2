...
int check_archive(int tar_fd) {
    ...
    for (file_count = 0;; ++file_count) {
        ...
        // check if the header was full of 0s, if that's the case, check that the next block of length 512 is also 0s, if that's the case then we reached the end of the tarball
